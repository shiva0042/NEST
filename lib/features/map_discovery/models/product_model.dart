...
List<ProductModel> _generateProducts() {
  ...
  final List<Map<String, dynamic>> baseItems = [
    ...
    {
      'name': 'Pavalamalli (Coral Jasmine)',
      'category': 'Flowers',
      'unit': 'weight',
      'bigBrands': ['Fresh Farms'],
      'smallBrands': {'Local Market': [1, 2, 3, 4]},
