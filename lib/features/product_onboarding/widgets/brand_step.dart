  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        // Use brand + subcategory for better logo/product image
        final query = '$brand ${provider.selectedSubcategory ?? ''} logo';
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.network(
                      ...
                      errorBuilder: (_, __, ___) => Container(
                        ...
                        child: const Icon(Icons.branding_watermark, color: Colors.grey, size: 20),
                      ),
                    ),
                  ),
                ),
